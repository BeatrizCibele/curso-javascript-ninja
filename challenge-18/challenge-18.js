(function(){
    ...
    */
    ...
    var monthPhrase = "Os meses de janeiro, junho e julho começam com a letra j.";
    console.log(monthPhrase.match(/j(ulh|unh)o/g));
    
    
    
    // console.log(monthPhrase.match(/j\w{3}o/g));
    ...
    */   
    ...
    // console.log(text.replace(/(<(\w+)>)([^<]+)(<\/\w+>)/g, function(allMatch, openTag, nameTag,content,closeTag){
    //     return `${openTag}O texto dentro da tag "${nameTag}" é "${content}" ${closeTag}\n`
    // }))
