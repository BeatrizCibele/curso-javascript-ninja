(function () {
  ...
  var replaceName = text.replace("Manuel Marques de Sousa", "Beatriz Dias");
  ...
  var replaceCity = replaceName.replace("brasileiro", "candanguense");
  ...
  var dashedReplace = replaceCity.replace(/\d/g, "-");
  // for (var i = 0; i < replaceCity.length; i++) {
  //   var numbers = parseInt(replaceCity[i]);
  //   dashedReplace += Number.isInteger(numbers) ? "-" : replaceCity[i];
  // }

  console.log(dashedReplace);
  ...
  var noDhLetters;
  noDhLetters = dashedReplace.replace(/[De-h]/g, 0);

  //arrayDh = ["D", "e", "f", "g", "h"];
  // for (i = 0; i < noDhLetters.length; i++) {
  //   if (arrayDh[i] > 4) {
  //     arrayDh[i];
  //   }
  //   var letter = arrayDh[i];
  //   noDhLetters = noDhLetters.replace(letter, 0);
  // }

  console.log(noDhLetters);
  ...
  var changingALetter = noDhLetters.replace(/[Aa]/g, 4);

  console.log(changingALetter);
  /*
    Substitua a frase "O Centauro de Luvas", deixando-a em caixa alta, usando
    o método `toUpperCase()`. Mostre o resultado no console:
    */
  console.log('\n"O Centauro de Luvas" em caixa alta:');
  var centauroDeLuvasUpper = changingALetter.replace(
    /C0nt4uro d0 Luv4s/,
    function (match) {
  ...
  console.log(centauroDeLuvasUpper);
  ...
  /*
  console.log("O mês de março é representado pelo número" + getMonthNumber(março));Agora, declare uma variável chamada `regexDate` que irá receber a expressão
